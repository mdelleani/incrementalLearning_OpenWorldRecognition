...
def Train(ResNet, task, train_Dataset, new_train_indexes):  #this function is used to add neurons to the fc layer and train the model
    ...
    if task > 0:
        ...
        in_features = ResNet.fc.in_features             #save  input features of old fc
        out_features = ResNet.fc.out_features           #save  output features of old fc
    ...
    for epoch in range(params.N_EPOCHS):
        ...
        for images, labels, indices  in train_loader:
            ...
            Id = torch.eye(params.TASK_CLASSES*(task+1))  #one-hot encoding
